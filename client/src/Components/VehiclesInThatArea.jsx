...
const VehiclesInThatArea = ({setSelectVehicleType, journeyDetails, setConfirmDetailsOfVehiclesPanel, setAllVehiclesInAreaPanel }) => {
  return (
    <div className='space-y-2'>
        <h4
          ...
          onClick={() => {
            setConfirmDetailsOfVehiclesPanel(true),
            setAllVehiclesInAreaPanel(false);
          ...
          className='flex items-center p-2 justify-between border-3  border-gray-400 rounded-lg  hover:bg-blue-50 hover:border-gray-500 active:border-black'>
            ...
            <h3 className='font-semibold text-xl mr-2'>{journeyDetails.car} bdt</h3>
          </div>
          ...
          className='flex items-center p-2 justify-between border-3  border-gray-400 rounded-lg hover:bg-blue-50 hover:border-gray-500 active:border-black'>
            ...
            <h3 className='font-semibold text-xl mr-2'>{journeyDetails.bike} bdt</h3>
          </div>
          ...
          className='flex items-center p-2 justify-between border-3  border-gray-400 hover:bg-blue-50 hover:border-gray-500 rounded-lg active:border-black'>
            ...
            <h3 className='font-semibold text-xl mr-2'>{journeyDetails.auto} bdt</h3>
          </div>
    </div>
  )
}
