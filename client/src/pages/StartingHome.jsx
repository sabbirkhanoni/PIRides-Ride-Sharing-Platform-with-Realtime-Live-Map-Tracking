...
const StartingHome = () => {
  ...
  return (
    ...
    >
      ...
      <footer className="bg-gray-600 text-white py-4 mt-10 px-10">
        <div className="container mx-auto text-center">
          
          <div className='flex justify-between items-center'>
            <div className=''>
              <img
              src="../src/assets/pirides.png" alt="Logo"
              className='h-8 w-15'
              />
            </div>
          ...
          <div className='grid lg:grid-cols-4  md:grid-cols-2 gap-8 mt-8 text-left lg:justify-items-center text-gray-300 hover:text-white'>
            <div>
              <h2>Company</h2>
              <ul>
