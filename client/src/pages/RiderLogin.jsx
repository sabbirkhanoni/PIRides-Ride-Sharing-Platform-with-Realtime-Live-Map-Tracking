    ...
    <div className='min-h-screen bg-white flex items-center justify-center p-4'>
      <div className='w-full max-w-md lg:border-2 lg:border-gray-200 lg:rounded-3xl lg:p-5'>
        ...
        <div className='px-3 flex justify-end mt-10'>
          <Link
            to='/user-login'
            className='w-full bg-orange-500 text-white border-2 border-gray-200 font-medium rounded-full py-2 transition-all duration-200 hover:border-orange-300 hover:bg-orange-600 flex items-center justify-center'
            >
